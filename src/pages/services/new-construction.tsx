...
const NewConstructionPage: React.FC = () => {
      ...
      <div className={classes["service-page"]}>
        ...
        <section className={classes["service-section"]}>
          ...
          <p>
            ...
            fugiat temporibus ipsam ipsa suscipit laudantium laborum nisi! Iure
            ...
            praesentium maiores! Quidem quis fugit ipsam beatae assumenda sequi
            a, voluptatum veniam dignissimos repellendus non alias laboriosam ad
            sint.
          </p>
