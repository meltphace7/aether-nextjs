      ...
      <section className={classes["split-feature-box"]}>
        <div className={classes["split-feature-box__text-container"]}>
          ...
          <p>
            ...
            culpa dicta quia aperiam ipsa cupiditate aut fuga aliquam eius
            aspernatur, fugiat consequatur praesentium necessitatibus ipsum non,
            sit quaerat minus veritatis.
          </p>
